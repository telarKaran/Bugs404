...
vector<string> row;
string line, word;
string fname = "SOI_workbookCSV.csv";
string fname2 = "SOI_workbookLocationCSV.csv";
...
fstream file (fname, ios::in);
	...
	// {
	// 	for(int j=0;j<Activity_Table[i].size();j++)
	// 	{
	// 		cout<<Activity_Table[i][j]<<" ";
	// 	}
	// 	cout<<"\n";
	// }


  // for(int i=0;i<Associated_Cost.size();i++)
	// {
	// 	for(int j=0;j<Associated_Cost[i].size();j++)
	// 	{
  //     if(Associated_Cost[i][j]==""){
  //       cout<<"*";
  //     }
	// 		cout<<Associated_Cost[i][j]<<" ";
	// 	}
	// 	cout<<"\n";
	// }
